...
3. Write components/<f>/knowledge/ref-<slug>.md — or
...
4. Transcripts: raw file → components/<f>/work/transcripts/ (or
...
5. NDA-adjacent → the restricted/ mirror of the chosen home —
   restricted/components/<f>/knowledge/ or restricted/narrative/knowledge/
   (same shapes).
