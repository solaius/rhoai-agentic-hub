...
[supported 2026-07-10](/components/agent-catalog/knowledge/decision-supported-not-validated-images.md))
...
Mode definitions: [fact-agent-deployment-modes](/components/agent-catalog/knowledge/fact-agent-deployment-modes.md).
