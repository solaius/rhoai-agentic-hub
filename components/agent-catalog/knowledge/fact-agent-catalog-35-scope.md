...
narrowed by the
[2026-07-09 no-deploy decision](/components/agent-catalog/knowledge/decision-agent-catalog-no-deploy-35.md)):
...
- Agents View: RH-curated starter-kit templates **and** harness kits from
  ...
  [confirmed in scope](/components/agent-catalog/knowledge/decision-harness-kits-in-scope-35-catalog.md)
