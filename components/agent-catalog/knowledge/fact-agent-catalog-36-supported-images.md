...
- **Supported images:** a limited, maintained set of harness images
  ...
  Candidates ([Jehlum's list](/components/agent-catalog/knowledge/ref-harness-candidates-gdoc.md)):
...
- **AIPCC base images:** ADR in GitLab (rhel-ai/core/team-docs MR 224,
  targeting 3.6) —
  [fit is questioned](/components/agent-catalog/knowledge/question-agent-catalog-aipcc-base-images-fit.md).
- **Bootstrap idea (Jehlum):** harness images preconfigured to work with the
  ...
  the MCP Gateway
  ([proposal](/components/agent-catalog/knowledge/ref-platform-skills-for-harnesses-gdoc.md));
...
- **Explicitly deferred:** purpose-built plug-and-play agents (e.g. LangGraph
  ...
  [framework-support boundary](/components/agent-catalog/knowledge/question-agent-catalog-framework-support-boundary.md).
...
[02-upstream](/components/agent-catalog/research/02-upstream.md).
