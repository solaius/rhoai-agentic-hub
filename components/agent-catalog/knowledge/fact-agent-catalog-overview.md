...
components: [agent-registry, agent-interop, mcp-catalog]
...
[kubeflow/hub](/components/mcp-catalog/knowledge/ref-kubeflow-hub-repo.md) like
its siblings. In 3.5 it surfaces the RH-curated
[agentic starter kits](/components/agent-catalog/knowledge/ref-agentic-starter-kits-repo.md)
...
- **RHOAI 3.5 (DP)** — read-only catalog + read-only agent deployments view.
  ...
  ([decision 2026-07-09](/components/agent-catalog/knowledge/decision-agent-catalog-no-deploy-35.md)).
  ...
  Full shape: [fact-agent-catalog-35-scope](/components/agent-catalog/knowledge/fact-agent-catalog-35-scope.md).
- **RHOAI 3.6 EA1 (planned)** — agent deployment from the catalog via the
  OpenShell Go SDK, restricted to
  [supported images](/components/agent-catalog/knowledge/fact-agent-catalog-36-supported-images.md);
...
- **Agent Registry** — work starts 3.6 EA2 at the earliest, multi-release
  ...
  [agent-registry](/components/agent-registry/index.md) scope.

## Boundaries (routing)

- Deployment runtime, sandboxing, identity, declarative harness →
  [agent-interop](/components/agent-interop/index.md)
- Versioning/governance of deployed agents →
  [agent-registry](/components/agent-registry/index.md)
- Catalog UI pattern sibling → [mcp-catalog](/components/mcp-catalog/index.md)
...
- Jira: [RHAISTRAT-1740](/components/agent-catalog/knowledge/ref-rhaistrat-1740.md) (owner: Alessio Pragliola)
- Content: [agentic-starter-kits repo](/components/agent-catalog/knowledge/ref-agentic-starter-kits-repo.md)
- Spine doc: [alignment/proposal GDoc](/components/agent-catalog/knowledge/ref-agent-catalog-alignment-gdoc.md)
- Slack: [#tmp-agent-catalog-templates-align](/components/agent-catalog/knowledge/ref-slack-tmp-agent-catalog-templates-align.md) ·
  [#forum-ai-asset-management](/components/platform/knowledge/ref-slack-forum-ai-asset-management.md)
- RHOAI architecture context: [opendatahub architecture repo](/components/platform/knowledge/ref-opendatahub-architecture-context-repo.md)
