...
3.5 on 2026-07-09
([decision](/components/agent-catalog/knowledge/decision-agent-catalog-no-deploy-35.md)),
so this contract now governs the 3.6 deployment flow — with "supported",
not "validated", images
([decision](/components/agent-catalog/knowledge/decision-supported-not-validated-images.md)).
...
See
[question-agent-catalog-protocol-diversity.md](/components/agent-catalog/knowledge/question-agent-catalog-protocol-diversity.md)
for the open protocol-standardization question, and
[ref-starter-kit-deployment-spec-rhoai-35.md](/components/agent-catalog/knowledge/ref-starter-kit-deployment-spec-rhoai-35.md)
for the full spec.
