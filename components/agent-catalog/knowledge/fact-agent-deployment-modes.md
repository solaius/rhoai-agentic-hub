...
- **Mode 2 — platform-owned.** Off-the-shelf harnesses (OpenCode, OpenClaw,
  ...
  [proposal doc](/components/agent-interop/knowledge/ref-declarative-harness-proposal-gdoc.md)).
...
[agent-registry](/components/agent-registry/index.md) scope; registry work
