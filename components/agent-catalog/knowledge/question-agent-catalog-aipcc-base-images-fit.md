...
([GitLab MR 224](/components/agent-catalog/knowledge/ref-aipcc-agent-base-images-adr.md),
...
[supported/validated terminology ruling](/components/agent-catalog/knowledge/decision-supported-not-validated-images.md).
