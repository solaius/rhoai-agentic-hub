...
[Jehlum's doc](/components/agent-catalog/knowledge/ref-harness-candidates-gdoc.md).
...
[fact-supported-images-enterprise-requirements](/components/agent-catalog/knowledge/fact-supported-images-enterprise-requirements.md)
and the [upstream research](/components/agent-catalog/research/02-upstream.md).
