...
components: [agent-catalog, skills-registry]
...
lands (see
[fact-ann-marie-poc-proposal](/components/agent-catalog/knowledge/fact-ann-marie-poc-proposal.md)).
...
[fact-catalog-deploy-stack](/components/agent-interop/knowledge/fact-catalog-deploy-stack.md)).

**Related**: [question-agent-catalog-harness-playground-integration](/components/agent-catalog/knowledge/question-agent-catalog-harness-playground-integration.md)
