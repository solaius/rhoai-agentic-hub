...
([RHAISTRAT-1740 resolved](/components/agent-catalog/knowledge/ref-rhaistrat-1740.md)).
...
[deploymentModel routing key](/components/agent-catalog/knowledge/fact-deployment-model-metadata-gap.md)
...
[agent-interop](/components/agent-interop/index.md)); not
versioning/governance of deployed agents ->
[agent-registry](/components/agent-registry/index.md); UI/backend pattern
sibling -> [mcp-catalog](/components/mcp-catalog/index.md). This partition
...
([personas](/components/platform/knowledge/fact-personas.md), [requirements
research](/components/agent-catalog/research/04-requirements.md)).

Market ([position](/components/agent-catalog/knowledge/fact-agent-catalog-market-position.md)):
...
regulatory tailwind ([enterprise requirements](/components/agent-catalog/knowledge/fact-supported-images-enterprise-requirements.md)).

## Where we stand

Decisions, in order:
[supported-images-only deploy MVP](/components/agent-catalog/knowledge/decision-agent-catalog-deploy-supported-images-only.md)
(2026-06-01) . YAML catalog source for disconnected (2026-06-08, in
[3.5 scope](/components/agent-catalog/knowledge/fact-agent-catalog-35-scope.md)) .
no admin UI in 3.5 (2026-06-18/22) .
[3.5 field set](/components/agent-catalog/knowledge/decision-agent-catalog-35-field-set.md)
(2026-07-02) .
[no deploy in 3.5](/components/agent-catalog/knowledge/decision-agent-catalog-no-deploy-35.md)
(2026-07-09) .
["supported", not "validated"](/components/agent-catalog/knowledge/decision-supported-not-validated-images.md)
(2026-07-10) .
[harness kits in scope for 3.5](/components/agent-catalog/knowledge/decision-harness-kits-in-scope-35-catalog.md)
(2026-07-11).

Delivery: **3.5 shipped** — RHAISTRAT-1740 resolved, RHAIENG-6156
(metadata) resolved; real filter_options data live with
[14 agents across 11 frameworks](/components/agent-catalog/knowledge/fact-agent-catalog-35-filter-response.md),
including harness kits (OpenCode, Claude Code, OpenClaw). Backend in
kubeflow/hub (spec #2907, artifacts endpoint #2928 —
[upstream schema](/components/agent-catalog/knowledge/fact-agent-catalog-upstream-schema.md)).
[Deployment-modes model](/components/agent-catalog/knowledge/fact-agent-deployment-modes.md)
(Mode 1/Mode 2 + binding) agreed. Research: 5 lenses + 1 focused refresh,
adversarially verified
([00-executive-summary](/components/agent-catalog/research/00-executive-summary.md)).
...
1. **OpenShell Go SDK is a single unmerged dependency** — PR series A-of-6
   ...
   slips ([research 02](/components/agent-catalog/research/02-upstream.md)).
2. **Supported harness set undecided** — licensing is now fact (Claude
   ...
   against image pinning ([question](/components/agent-catalog/knowledge/question-agent-catalog-supported-harness-set.md)).
3. **Nobody owns the image treadmill** — Health Index grading, CVE SLAs,
   ...
   near-term" only ([question](/components/agent-catalog/knowledge/question-agent-catalog-ownership-packaging.md)).
4. **AIPCC base-image fit unresolved** — ADR targets 3.6 while catalog
   contents churn ([question](/components/agent-catalog/knowledge/question-agent-catalog-aipcc-base-images-fit.md)).
...
8. **Starter kits vs quick starts boundary** — the golden-path checklist
   ...
   kits from being "glorified quick starts" ([question](/components/agent-catalog/knowledge/question-agent-catalog-quickstarts-overlap.md));
...
9. **deploymentModel is the unstated deploy routing key** — config-driven
   ...
   [parsing gap](/components/agent-catalog/knowledge/fact-deployment-model-metadata-gap.md)
   ...
   ([research 06](/components/agent-catalog/research/06-requirements-deployment-model-metadata.md)).
10. **Flow-import deploy scope for 3.6 EA1** — supporting flow-import
    ...
    ([question](/components/agent-catalog/knowledge/question-flow-import-deploy-scope.md)).

## Jira map

| strategy element | keys | status |
|---|---|---|
| Catalog surface (3.5) | [RHAISTRAT-1740](/components/agent-catalog/knowledge/ref-rhaistrat-1740.md) (Feature) | **Release Pending (Done)** |
| Agent Hub UI umbrella | [RHAISTRAT-1697](/components/agent-catalog/knowledge/ref-rhaistrat-1697-agent-hub-ui.md) (Outcome) | In Progress — framing predates the OpenShell pivot |
| Deploy-write path (3.6) | [RHAISTRAT-1742](/components/agent-catalog/knowledge/ref-rhaistrat-1742-deploy-from-ai-hub.md) (Feature) | In Progress |
| Deployments view (3.5) | [RHAISTRAT-1758](/components/agent-catalog/knowledge/ref-rhaistrat-1758-agent-deployments-view.md) (Feature) | Review |
| Supported images / runtime compat | [RHAISTRAT-1349](/components/agent-catalog/knowledge/ref-rhaistrat-1349-runtime-compatibility.md) (Outcome) + RHAIRFE-2443 | In Progress — image-tier naming predates the supported ruling |
| Eval / validated tier (later) | [RHAISTRAT-1792](/components/agent-catalog/knowledge/ref-rhaistrat-1792-agent-eval-starter-kit.md) (Feature) | In Progress |
| Declarative binding | RHAIRFE-2309 / RHAIRFE-2310 | shared with [agent-interop](/components/agent-interop/index.md) |
| Metadata delivery | [RHAIENG-6156](/components/agent-catalog/knowledge/ref-rhaieng-6156-agent-metadata.md) | **Resolved (Done)** |
| Backend delivery stream | RHOAIENG AI Hub component (~30 items in the [snapshot](/components/agent-catalog/work/jira-snapshot.yaml)) | flowing — 15 subtasks resolved/closed since last sweep |
