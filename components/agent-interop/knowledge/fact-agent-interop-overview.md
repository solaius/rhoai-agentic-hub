...
components: [agent-interop, agent-registry, agent-ops]
...
contributions. See
[decision-openshell-strategic-bet.md](/components/agent-interop/knowledge/decision-openshell-strategic-bet.md).
...
[agent-registry](/components/agent-registry/); post-deployment
observability/SDLC oversight in [agent-ops](/components/agent-ops/);
MCP-level tool governance in
[mcp-gateway](/components/mcp-gateway/).
