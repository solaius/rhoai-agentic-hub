...
2641 per the [surface/persona rule](/components/platform/knowledge/fact-ai-hub-vs-gen-ai-studio-surfaces.md).
...
page: /components/agent-memory/enablement/agent-memory-rfe-narrative/).
