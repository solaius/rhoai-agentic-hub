...
- Jonathan Zarecki's Feast+OGX proposal — [ref-feast-ogx-agent-memory-proposal.md](/components/agent-memory/knowledge/ref-feast-ogx-agent-memory-proposal.md)
- Umberto Manganiello's Unified Platform (3-phase Feast) proposal — [ref-unified-platform-agentic-memory-infrastructure.md](/components/agent-memory/knowledge/ref-unified-platform-agentic-memory-infrastructure.md)
- Wes Jackson's MemoryHub — [ref-memory-hub-repo.md](/components/agent-memory/knowledge/ref-memory-hub-repo.md)
...
MemoryHub pair ([sync fact](/components/agent-memory/knowledge/fact-agent-memory-team-sync-20260707-transcript.md)).
