...
The project owner, Peter Double, proposed an initial decomposition into three areas ([agent-memory-knowledge seed doc](/components/agent-memory/research/agent-memory-landscape-research.md) §1):
...
|---|---|---|---|---|
| **A — Peter's 3 areas** | Platform concern | What subsystems/Outcomes to build | Product decomposition | [seed doc](/components/agent-memory/research/agent-memory-landscape-research.md) §1 |
...
RHAISTRAT-1345's scope is: short-term conversation state, long-term knowledge persistence, context compaction, cross-framework memory abstractions ([seed doc](/components/agent-memory/research/agent-memory-landscape-research.md) §2).
...
| **Subsystem 3 — Agent Knowledge** | **No — not clearly in scope.** RHAISTRAT-1345 maps cleanly onto Peter's areas 2 and 3 but not area 1 ([seed doc](/components/agent-memory/research/agent-memory-landscape-research.md) §2 note; [01](01-landscape-and-definitions.md) §5.1). |
...
| Oracle AI Agent Memory (Richmond Alake, 2026-05-01) | "Four access patterns over one substrate" argument; LongMemEval 93.8% | [01](01-landscape-and-definitions.md) §4, [02](02-solution-survey.md) §3.1, [seed doc](/components/agent-memory/research/agent-memory-landscape-research.md) §4 |
| When Agent Memory Becomes a Platform Concern (Wes Jackson, 2026-05-01) | Memory ≠ RAG; database-not-search; platform-tier framing | [01](01-landscape-and-definitions.md) §2, [seed doc](/components/agent-memory/research/agent-memory-landscape-research.md) §6 |
