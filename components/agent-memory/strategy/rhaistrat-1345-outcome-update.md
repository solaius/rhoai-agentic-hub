...
RHAISTRAT-1345 currently has **no child Features** — Peter authors them after research ([seed doc](/components/agent-memory/research/agent-memory-landscape-research.md) §2). The Phase 2 [RFE roadmap](rfe-roadmap.md) outlines the proposed Features, sequenced to the 3.6 / 3.7 / 3.8+ delivery plan. In summary:
...
| Current ticket ([seed doc](/components/agent-memory/research/agent-memory-landscape-research.md) §2) | Proposed rewrite | Basis |
|---|---|---|
...
| Source | Used for |
|---|---|
| [REVIEW-NOTES.md](/components/agent-memory/research/REVIEW-NOTES.md) | D1–D5 — the decisions the rewrite reflects |
| [agent-memory-knowledge.md](/components/agent-memory/research/agent-memory-landscape-research.md) §2 | The current RHAISTRAT-1345 ticket text |
...
| [Phase 2 research (docs 09–15)](/components/agent-memory/research/) | Timeline shift context and scope-reshaping findings |
