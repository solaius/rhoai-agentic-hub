...
Related siblings: none declared in components.yaml. Cross-references:
...
1. **Runs alongside harness memory** — both systems operate during a
   ...
   deduplicates
   ([fact-adel-positioning-alongside-harness](/components/agent-memory/knowledge/fact-adel-positioning-alongside-harness.md))
...
([research 21](/components/agent-memory/research/21-competitive-landscape-2026-07.md) §3.1):
...
([research 21](/components/agent-memory/research/21-competitive-landscape-2026-07.md) §3.3).
...
|---|---|---|
| 2026-05-17 | Decomposition: 3 subsystems + 2 cross-cutting dimensions (D1) | [REVIEW-NOTES](/components/agent-memory/research/REVIEW-NOTES.md) |
| 2026-05-17 | RHAISTRAT-1345 scoped to Substrate + Context Eng; Knowledge deferred (D2) | [REVIEW-NOTES](/components/agent-memory/research/REVIEW-NOTES.md) |
| 2026-05-17 | Phased sourcing: OGX substrate + MemoryHub governance + build-fresh for Knowledge (D3/D5) | [REVIEW-NOTES](/components/agent-memory/research/REVIEW-NOTES.md) |
| 2026-05-17 | Standards workstream runs in parallel from day one (D6) | [REVIEW-NOTES](/components/agent-memory/research/REVIEW-NOTES.md) |
| 2026-06-30 | Standalone service (decoupled from OGX AND AI Gateway) | [fact-1on1](/components/agent-memory/knowledge/fact-agent-memory-1on1-paths-forward-20260630.md) |
| 2026-06-30 | Phasing: 3.6 DP → 3.7 TP → 3.8 GA | [fact-1on1](/components/agent-memory/knowledge/fact-agent-memory-1on1-paths-forward-20260630.md) |
| 2026-07-07 | Feast ruled out as interim memory; OGX memory tool + MemoryHub pair | [fact-sync-0707](/components/agent-memory/knowledge/fact-agent-memory-team-sync-20260707-transcript.md) |
| 2026-07-10 | Fourteen RFEs filed (RHAIRFE-2630..2643) | [fact-rfes-filed](/components/agent-memory/knowledge/fact-rhaistrat-1345-rfes-filed-20260710.md) |
...
- **Positioning**: Adel Zaalouk's positioning musings ingested
  ([ref](/components/agent-memory/knowledge/ref-adel-agent-memory-positioning-musings.md))
...
| Q-T3 — Scope-tier count | Six tiers vs four OpenShift-native tiers for MVP | Recommendation: four for MVP ([strategy §6.2](/components/agent-memory/strategy/agent-memory-strategy.md#62-scope-tier-model--recommendation-ship-four-openshift-native-tiers-for-the-mvp-keep-the-remaining-tiers-as-a-design-horizon)) |
...
- **Procedural memory**: Microsoft shipped it; our RFE roadmap defers it
  ...
  ([research 21](/components/agent-memory/research/21-competitive-landscape-2026-07.md) §3.4)
- **Benchmark reliability weakening**: vendor-claimed benchmarks
  ...
  ([research 21](/components/agent-memory/research/21-competitive-landscape-2026-07.md) §5)
...
| 2026-07-28 | MCP spec largest revision (statelessness) | Memory-as-MCP session identity must live in the memory service, not the protocol ([research 19](/components/agent-memory/research/19-market-direction-refresh-2026-07.md) §4) |
