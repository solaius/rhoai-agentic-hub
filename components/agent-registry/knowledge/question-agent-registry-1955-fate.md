...
([research/09-architecture](/components/agent-registry/research/09-architecture.md) §3),
...
[question-byo-agent-discovery-labels](/components/agent-registry/knowledge/question-byo-agent-discovery-labels.md).
