...
endpoints. See
[research/09-architecture](/components/agent-registry/research/09-architecture.md) §1.6.
...
[question-agent-registry-1955-fate](/components/agent-registry/knowledge/question-agent-registry-1955-fate.md).
