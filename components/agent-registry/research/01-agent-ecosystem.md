...
Building on the [Skills Ecosystem Research](/components/skills-registry/research/01-skills-ecosystem.md) abstraction ladder for tools and skills, agents sit at the top of a broader hierarchy:
...
- Varsha's Agent Registry Proposal: [agents/agent-registry-upstream-proposal.md](/components/agent-registry/strategy/upstream-proposal.md)

### Internal References

- Skills Ecosystem Research: [skills/skills-registry/research/01-skills-ecosystem.md](/components/skills-registry/research/01-skills-ecosystem.md)
