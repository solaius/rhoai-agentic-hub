...
Varsha's upstream proposal already defines an extended `AgentSkill` with an additional `parameters: list[SkillParameter]` field -- an important governance extension over the base A2A spec (see [agent-registry-upstream-proposal.md](/components/agent-registry/strategy/upstream-proposal.md)).
...
- Varsha's Agent Registry Proposal: [agent-registry-upstream-proposal.md](/components/agent-registry/strategy/upstream-proposal.md)
