...
Varsha Prasad Narsing's agent registry proposal defines three integration patterns between kagenti and MLflow (see [agent-registry-upstream-proposal.md](/components/agent-registry/strategy/upstream-proposal.md)):
