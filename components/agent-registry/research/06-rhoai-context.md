...
| Pattern | Transfers? | What Changes for Agents |
|---|---|---|
| **Upstream/downstream story split** | Yes | The skills [user stories](/components/skills-registry/strategy/user-stories.md) cleanly separate upstream MLflow stories (U1-U7) from RHOAI-specific stories (R1-R8). This template directly informs agent registry story structure. |
...
- [Skills Registry User Stories](/components/skills-registry/strategy/user-stories.md) -- upstream/downstream split template
- [Skills RHOAI Patterns and Meetings](/components/skills-registry/research/04-rhoai-patterns-and-meetings.md) -- transferability analysis pattern
...
- [Agent Registry Upstream Proposal](/components/agent-registry/strategy/upstream-proposal.md) -- Varsha's post-deployment proposal (local copy)
