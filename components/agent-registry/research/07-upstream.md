...
[agent-catalog upstream doc](/components/agent-catalog/research/02-upstream.md),
...
[agent-catalog upstream §3](/components/agent-catalog/research/02-upstream.md).
...
[agent-catalog upstream §6](/components/agent-catalog/research/02-upstream.md)
