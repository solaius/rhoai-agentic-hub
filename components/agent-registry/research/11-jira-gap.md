...
[agent-interop jira-gap](/components/agent-interop/research/06-jira-gap.md)
...
([07-upstream](/components/agent-registry/research/07-upstream.md),
[08-landscape](/components/agent-registry/research/08-landscape.md),
[09-architecture](/components/agent-registry/research/09-architecture.md),
...
- **Auxiliary baselines** (committed snapshots, summaries withheld for
  disclosure reasons):
  [agent-interop/work/jira-snapshot.yaml](/components/agent-interop/work/jira-snapshot.yaml)
  (209 issues, swept 2026-07-11) and
  [agent-catalog/work/jira-snapshot.yaml](/components/agent-catalog/work/jira-snapshot.yaml)
...
- **Ahead — existence and authorship.** The backend the research
  ...
  ([question-rfc0008-phase2-agent-entity](/components/agent-registry/knowledge/question-rfc0008-phase2-agent-entity.md))
...
- **Different approach — single entity, single track.** The schema
  ...
  [09 §2.1](/components/agent-registry/research/09-architecture.md) —
...
- **Behind — the registry view has no scheduled data source.** The
  ...
  [question-registry-view-ea1-data-source](/components/agent-registry/knowledge/question-registry-view-ea1-data-source.md)
...
[interop jira-gap §6](/components/agent-interop/research/06-jira-gap.md).
...
1. **[interop 06-jira-gap](/components/agent-interop/research/06-jira-gap.md)
...
2. **[00-executive-summary](/components/agent-registry/research/00-executive-summary.md)
...
- Research inputs:
  ...
  [09-architecture](/components/agent-registry/research/09-architecture.md) ·
  [10-requirements](/components/agent-registry/research/10-requirements.md) ·
  [knowledge index](/components/agent-registry/knowledge/index.md) ·
  [interop 06-jira-gap](/components/agent-interop/research/06-jira-gap.md)
