...
tags: [ai-gateway, cost, its]
source: ai-asset-registry/docs/knowledge-registry.md §13 (as of 2026-07-05)
---
Gap identified at the AI Gateway F2F: if the gateway's intelligent routing (Filter/Scorer/Picker, decision 3 in [decision-ai-gateway-f2f-architecture.md](/restricted/components/platform/knowledge/decision-ai-gateway-f2f-architecture.md)) selects a more expensive model on failover, and inference-time-scaling fan-out multiplies requests on top of that, costs could compound in a way nothing currently guards against.
