...
## Connections
- reference · [Gen AI Studio playground must support AI Gateway as alternative to OGX](/components/ai-gateway/knowledge/ref-rhaistrat-1935-gen-ai-studio-gateway.md) — Feature to decouple Gen AI Studio from OGX-only backend, enabling AI Gateway as an alternative serving path; parent RHAISTRAT-1312; cross-component with gen-ai-studio.
