...
Full architecture writeup (system diagram, tech stack, request flow, ADRs, roadmap by theme, open questions): [gen-ai-studio-architecture.md](/components/gen-ai-studio/research/gen-ai-studio-architecture.md).
