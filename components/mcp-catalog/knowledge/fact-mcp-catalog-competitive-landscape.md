...
source: hub.research run 2026-07-09 (adversarially verified) — /components/mcp-catalog/research/02-competitive-mcp-catalogs.md
---

Supersedes the 2026-07-06 seven-competitor snapshot
([old entry](/components/mcp-ecosystem/knowledge/fact-competitive-landscape-mcp-catalogs.md)).
Full detail and sources: [research 02](/components/mcp-catalog/research/02-competitive-mcp-catalogs.md).
