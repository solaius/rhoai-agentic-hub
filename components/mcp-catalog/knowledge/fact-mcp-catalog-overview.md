...
components: [mcp-ecosystem, mcp-registry]
...
([launch blog](/components/mcp-ecosystem/knowledge/ref-mcp-catalog-launch-blog.md)).
...
[model-metadata-collection](/components/mcp-ecosystem/knowledge/ref-model-metadata-collection-repo.md).

## Boundaries (routing)

- Partner onboarding pipeline, evaluation, server building →
  [mcp-ecosystem](/components/mcp-ecosystem/index.md)
- Governance / system-of-record / data model →
  [mcp-registry](/components/mcp-registry/index.md)
- Runtime connectivity → [mcp-gateway](/components/mcp-gateway/index.md)
- This partition: the catalog product surface — discovery UX, AI Hub
  integration, release train, catalog STRATs.

## Key links

- Code upstream: [kubeflow/hub](/components/mcp-catalog/knowledge/ref-kubeflow-hub-repo.md)
  (owner-confirmed 2026-07-10); content upstream:
  [model-metadata-collection](/components/mcp-ecosystem/knowledge/ref-model-metadata-collection-repo.md)
- [Launch blog (live)](/components/mcp-ecosystem/knowledge/ref-mcp-catalog-launch-blog.md)
- [PM write-up / requirements GDoc](/components/mcp-registry/knowledge/ref-mcp-catalog-writeup.md)
- [Catalog STRAT Jiras](/components/mcp-catalog/knowledge/ref-mcp-catalog-strat-jiras.md)
- Slack: [#forum-ai-asset-management](https://redhat-internal.slack.com/archives/C091PSZ5BB8)
  (see the [channel index](/components/platform/knowledge/fact-slack-channels-by-product-area.md))
- Presentation: [MCP management hub](/components/mcp-ecosystem/enablement/management-hub/index.html)
