...
source: hub.research run 2026-07-09 (adversarially verified) — /components/mcp-catalog/research/01-upstream-mcp-catalog-registry.md
---

Decision-ready upstream atoms (all primary-source verified 2026-07-09;
detail in [research 01](/components/mcp-catalog/research/01-upstream-mcp-catalog-registry.md)):
...
- **Federation model**: downstream vendor catalogs are expected to poll
  ...
  [open question](/components/mcp-catalog/knowledge/question-official-registry-federation.md).
...
- **Spec**: largest revision since launch finalizes **2026-07-28**
  ...
  [open question](/components/mcp-catalog/knowledge/question-spec-version-policy-ga.md).
