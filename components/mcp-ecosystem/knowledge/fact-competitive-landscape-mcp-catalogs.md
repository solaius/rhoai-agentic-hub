...
status: superseded
superseded_by: /components/mcp-catalog/knowledge/fact-mcp-catalog-competitive-landscape.md
...
**Red Hat's differentiator**: none of the above own enterprise governance, lifecycle management, policy enforcement, and platform integration — they solve discovery/listing, not governance. This is the gap the MCP Registry (see [fact-mcp-registry.md](/components/mcp-registry/knowledge/fact-mcp-registry.md)) is built to fill.
