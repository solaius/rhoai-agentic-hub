...
See [decision-mcp-gateway-tool-governance-scope.md](/components/mcp-gateway/knowledge/decision-mcp-gateway-tool-governance-scope.md) for scope boundaries and [fact-mcp-gateway-roadmap.md](/components/mcp-gateway/knowledge/fact-mcp-gateway-roadmap.md) for phased rollout.
