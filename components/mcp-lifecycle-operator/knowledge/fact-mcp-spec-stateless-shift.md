...
description: The MCP spec removes session state (no initialize handshake, no session header, self-contained requests), adds routing headers for gateways, caching, and distributed tracing. Simplifies MCPLO horizontal scaling. Spec finalized and published July 28, 2026.
timestamp: 2026-07-28
tags: [mcp-lifecycle-operator, mcp-spec, stateless, architecture]
components: [mcp-gateway, mcp-ecosystem, mcp-catalog]
review_after: 2026-08-15
source: landscape research 2026-07-11; MCP 2026-07-28 final release blog
---

The MCP 2026-07-28 specification (published July 28, 2026) makes MCP
...
Source: [MCP 2026-07-28](https://blog.modelcontextprotocol.io/posts/2026-07-28/)
