...
The 3.5 target replaces steps 3–4 of the manual flow (register in Gateway, update ConfigMap by hand) with registry governance as the source of truth — see [fact-mcp-registry.md](/components/mcp-registry/knowledge/fact-mcp-registry.md).
