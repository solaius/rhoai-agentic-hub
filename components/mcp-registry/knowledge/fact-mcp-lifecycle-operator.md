...
Upstream code: [ref-mcp-lifecycle-operator-repo.md](/components/mcp-registry/knowledge/ref-mcp-lifecycle-operator-repo.md). Entitlement/packaging detail (RHOAI restricted use entitlement for OpenShift requirement) lives in the restricted counterpart of this entry.
