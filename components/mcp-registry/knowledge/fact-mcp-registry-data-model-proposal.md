...
---
From the MLflow MCP Registry Data Model Proposal (brain dump, not finalized — see [ref-mlflow-mcp-registry-data-model-proposal.md](/components/mcp-registry/knowledge/ref-mlflow-mcp-registry-data-model-proposal.md)):
