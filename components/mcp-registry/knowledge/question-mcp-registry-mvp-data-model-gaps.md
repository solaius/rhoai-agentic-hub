...
---
[fact-mcp-registry-data-model-proposal.md](/components/mcp-registry/knowledge/fact-mcp-registry-data-model-proposal.md) describes the proposed four-track governance model, but these specifics are still undecided for 3.5 Dev Preview:
