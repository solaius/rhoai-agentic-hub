...
See [fact-mcp-registry-data-model-proposal.md](/components/mcp-registry/knowledge/fact-mcp-registry-data-model-proposal.md) and [fact-mcp-flow-34-to-35.md](/components/mcp-registry/knowledge/fact-mcp-flow-34-to-35.md).
