...
Models is the one asset type not yet on the registry side of this split (still Kubeflow-Hub-backed pending the MLflow move — see [fact-model-registry-kubeflow-hub.md](/components/platform/knowledge/fact-model-registry-kubeflow-hub.md)); Skills' "MLflow (prototype)" reflects the Databricks MVP branch state, not a finalized backend choice (see [fact-skills-registry-mvp-analysis.md](/components/skills-registry/knowledge/fact-skills-registry-mvp-analysis.md)). Guardrails backend is still TBD.

See [fact-ai-asset-registries-sync-transcript.md](/components/platform/knowledge/fact-ai-asset-registries-sync-transcript.md) for the meeting this decision came from, and [ref-ai-asset-registries-prd.md](/components/platform/knowledge/ref-ai-asset-registries-prd.md) for the PRD it anchors. Compare [fact-model-registry-kubeflow-hub.md](/components/platform/knowledge/fact-model-registry-kubeflow-hub.md), which shows Kubeflow Hub already living the "catalog" role for models today.
