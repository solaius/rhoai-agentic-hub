...
A future move toward an MLflow-based direction for the model registry itself has also been flagged, as part of the broader Databricks/MLflow upstream collaboration (see [fact-databricks-mlflow-upstream-process.md](/components/platform/knowledge/fact-databricks-mlflow-upstream-process.md)) — consistent with [decision-registry-vs-catalog.md](/components/platform/knowledge/decision-registry-vs-catalog.md)'s registry=MLflow split, though not yet a committed plan as of source capture.

See [decision-kubeflow-hub-rename.md](/components/platform/knowledge/decision-kubeflow-hub-rename.md) for the KEP-0003 rename, and [ref-kubeflow-model-registry-repo.md](/components/platform/knowledge/ref-kubeflow-model-registry-repo.md) for the code.
