...
---
Snapshot as of the Apr 2026 Messaging Guide (see [ref-agentic-messaging-guide.md](/components/platform/knowledge/ref-agentic-messaging-guide.md)) — expect drift by 3.5/3.6, re-verify before reuse:
