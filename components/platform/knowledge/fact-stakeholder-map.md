...
| Andrew Mackenzie | MCP Gateway delivery/packaging | Flagged the OCP 5.0 deployment plan as urgently needing to be nailed down — see [question-ocp5-olm-dependency-removal.md](/components/platform/knowledge/question-ocp5-olm-dependency-removal.md) |
...
| Chris Hambridge | Product Management | With Matt Prahl, raised whether MCPLO should create read-only "discovered/managed" entries — see [question-mcp-registry-state-propagation.md](/components/mcp-registry/knowledge/question-mcp-registry-state-propagation.md); also does 3.4 catalog integration/testing |
...
| Alessio | Kubeflow plugin architecture | Genericizing the model-registry asset-type model (PR #2219) — see [fact-model-registry-kubeflow-hub.md](/components/platform/knowledge/fact-model-registry-kubeflow-hub.md) |
...
| Name | Role/Area | Notes |
|---|---|---|
| Adam Bellusci | Leadership — Registry/Catalog direction | Source of the "MLflow is for registries. Kubeflow is for catalogs. We're done." framing in [decision-registry-vs-catalog.md](/components/platform/knowledge/decision-registry-vs-catalog.md) |
| Ann Murray | Pushing Snyk for AI/agent scanning | See [fact-mcp-ingestion-pipeline.md](/components/mcp-ecosystem/knowledge/fact-mcp-ingestion-pipeline.md) |
...
| Noel O'Connor | Sales/field | Raised the seller-confusion risk on IBM/RH agentic positioning — see [decision-ibm-redhat-agentic-ai-positioning.md](/components/platform/knowledge/decision-ibm-redhat-agentic-ai-positioning.md) |
...
| Roberto | Summit Agent Ops talk (with Younes Ben Brahim and Peter Double) | See [fact-summit-2026.md](/components/platform/knowledge/fact-summit-2026.md) |
...
| Rutuja Argade | Support Manager, RHAI | Raised the OCP 4.20 upgrade-timing and ticket-workflow question — see [question-rhoai-rhcl-ocp419-gap.md](/restricted/components/mcp-gateway/knowledge/question-rhoai-rhcl-ocp419-gap.md) |
...
| Name | Role/Area | Notes |
|---|---|---|
| Erwan Granger | Field/consulting | Raised the cluster-admin requirement concern — see [question-mcp-fernando-lozano-doc-gaps.md](/components/mcp-ecosystem/knowledge/question-mcp-fernando-lozano-doc-gaps.md) |
...
See [fact-ai-gateway.md](/components/ai-gateway/knowledge/fact-ai-gateway.md) and [decision-ai-gateway-f2f-architecture.md](/restricted/components/platform/knowledge/decision-ai-gateway-f2f-architecture.md).
...
See [person-arjay-hinek.md](/components/platform/knowledge/person-arjay-hinek.md) (rubric author).
...
See [person-ryan-cook.md](/components/agent-memory/knowledge/person-ryan-cook.md) and [person-sanjeev-rampal.md](/components/agent-memory/knowledge/person-sanjeev-rampal.md) (workstream leads).
...
See [question-feast-mem0-pluggable-storage.md](/components/agent-memory/knowledge/question-feast-mem0-pluggable-storage.md).

### RHOAI restricted use entitlement for OpenShift / OLS
| Name | Role/Area | Notes |
|---|---|---|
| Joshua Wilson | Engineering, OLS | Raised the RHOAI restricted use entitlement pricing/paywall concern for OLS's MCP features — already captured in [ref-rhoai-limited-mcp-lifecycle-faq.md](/restricted/components/mcp-registry/knowledge/ref-rhoai-limited-mcp-lifecycle-faq.md) |
...
| Doug Hellmann | Engineering | Raised the product ID, UBI version, and dependency questions — see [question-agentic-base-images-ubi-version.md](/components/agent-registry/knowledge/question-agentic-base-images-ubi-version.md) and [question-agentic-base-images-product-id.md](/components/agent-registry/knowledge/question-agentic-base-images-product-id.md) |
| Kamesh | Engineering — repo structure for starter kits | Suggested the omnigent meta-harness approach — see [ref-omnigent-repo.md](/components/agent-registry/knowledge/ref-omnigent-repo.md) |
...
See [person-manuela-ansaldo.md](/components/platform/knowledge/person-manuela-ansaldo.md) (docs program lead).
