...
[the terminology decision](/components/agent-catalog/knowledge/decision-supported-not-validated-images.md);
...
([framework boundary question](/components/agent-catalog/knowledge/question-agent-catalog-framework-support-boundary.md)).
Taking the reconciliation to the
[AIPCC base-images ADR](/components/agent-catalog/knowledge/ref-aipcc-agent-base-images-adr.md)
directly.
