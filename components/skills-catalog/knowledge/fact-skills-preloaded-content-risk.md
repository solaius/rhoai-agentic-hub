...
RHAISTRAT-1940: Pre-loaded skills for out-of-box value.
Status: New, PM unassigned. Called out as a top risk in RHAISTRAT-1780.

Without pre-loaded content, the catalog launches empty -- zero value on
day one.
...
|---|---|---|
| Agentic Starter Kits | Already in odh-dashboard as quickstarts | Needs conversion to skill format |
| MCP tool configurations | rhoai-mcp repository | Needs packaging |
