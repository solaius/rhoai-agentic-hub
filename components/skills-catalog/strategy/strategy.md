...
|---|---|---|
| **3.6 TP** (Oct 2026 code freeze) | Browse-only catalog: search/filter UI, skill detail cards, 15-20 pre-loaded RH skills, Git-backed YAML metadata, trust tier badges, ConfigMap disconnected import, category/tag filtering, skill card display (where available), signing status badge (informational) | In progress, no blockers ([ref-skills-architectural-strategy-gdoc](/components/skills-catalog/knowledge/ref-skills-architectural-strategy-gdoc.md)) |
...
- SKILL.md is the standard (40+ tools, AAIF/Linux Foundation governed).
  See [ref-agentskills-io-spec](/components/skills-catalog/knowledge/ref-agentskills-io-spec.md).
...
- **RHAISTRAT-1780** (Skills Catalog): development in progress, no
  ...
  [fact-skills-catalog-rhaistrat-1780-scope](/components/skills-catalog/knowledge/fact-skills-catalog-rhaistrat-1780-scope.md).
- **RHAISTRAT-1940** (Pre-loaded skills): **PM unassigned**. Top risk.
  See [fact-skills-preloaded-content-risk](/components/skills-catalog/knowledge/fact-skills-preloaded-content-risk.md).
- **RFC-0008/0009** (Skills Registry in MLflow): POC code developed,
  ...
  [fact-skills-rfc-split-databricks](/components/skills-registry/knowledge/fact-skills-rfc-split-databricks.md).
...
- Ann Marie Fred: authored the cross-team architectural strategy for the
  ...
  [ref-skills-architectural-strategy-gdoc](/components/skills-catalog/knowledge/ref-skills-architectural-strategy-gdoc.md).
...
- **Konflux skills pipeline not planned** -- the three-layer scanning
  ...
  [06-architecture-refresh](/components/skills-catalog/research/06-architecture-refresh.md).
...
- **Metadata source-of-truth debate** -- Roland Huss challenges the
  ...
  [question-skills-metadata-source-split](/components/skills-catalog/knowledge/question-skills-metadata-source-split.md).
- **LOLA has no active maintainers** -- may be archived unless AAET
  commits. Deprioritize in favor of OCI + npx/APM. See
  [07-requirements-refresh](/components/skills-catalog/research/07-requirements-refresh.md).
...
- **Installation features location** -- catalog, registry, or both?
  ...
  [question-skills-installation-features-location](/components/skills-catalog/knowledge/question-skills-installation-features-location.md).
- **NVIDIA collaboration model** -- collaborate on verification pipeline,
  ...
  See [question-skills-catalog-nvidia-collaboration](/components/skills-catalog/knowledge/question-skills-catalog-nvidia-collaboration.md).
