...
Full data model, packaging/install-mode detail, and gap analysis vs. Red Hat's governance proposal: see [fact-skills-registry-mvp-analysis.md](/components/skills-registry/knowledge/fact-skills-registry-mvp-analysis.md).
