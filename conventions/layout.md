...
feature? which type?**
- Feature list = `components/components.yaml` (the routing table; `components/index.md` is generated from it).
...
## Feature families
`related:` in `components/components.yaml` declares a feature's boundary
