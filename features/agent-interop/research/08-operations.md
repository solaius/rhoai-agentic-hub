...
- `/features/agent-interop/knowledge/fact-openshell-architecture.md`
- `/features/agent-interop/knowledge/fact-openshell-capability-gaps.md`
- `/features/agent-interop/knowledge/fact-openshell-openshift-deployment.md`
- `/features/agent-interop/knowledge/fact-openshell-product-timeline.md`
- `/features/agent-interop/knowledge/decision-openshell-dp-postgres.md`
- `/features/agent-interop/knowledge/decision-openshell-base-image-dual-path.md`
- `/features/agent-interop/research/00-executive-summary.md`
- `/features/agent-interop/research/06-jira-gap.md`
