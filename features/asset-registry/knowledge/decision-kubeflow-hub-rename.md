...
tags: [asset-registry, kubeflow, rename]
...
**Consequences**: Signals the project's direction toward a generic multi-asset-type hub, aligning with this proposal's own Registry-vs-Catalog framing. Repo name itself (`kubeflow/model-registry`) has not yet changed as of source capture.
