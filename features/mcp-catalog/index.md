...
## Connections
- decision · [Maintained catalog images are "supported", not "validated"](/features/agent-catalog/knowledge/decision-supported-not-validated-images.md) — 2026-07-10 — in RHOAI "validated" already means vendor-provided images Red Hat certifies but the vendor maintains (NVIDIA Triton); catalog images Red Hat maintains are "supported".
