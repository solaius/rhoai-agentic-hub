...
## fact
- [Ramesh's position -- skills need no governance; governance at agent level](/features/skills-registry/knowledge/fact-ramesh-skills-governance-position.md) — Ramesh argues skills are static resources with no behavior/deployment, needing no governance layer; governance belongs at agent create/deploy/execute level; registry value is lower than catalog value for skills specifically.
...
- [MLflow RFC PR #27 -- post-MVP Skill Registry design](/features/skills-registry/knowledge/ref-mlflow-skills-registry-post-mvp-rfc.md) — Post-MVP RFC for the MLflow Skill Registry -- extends RFC-0008 (PR
