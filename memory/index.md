...
- [now](/memory/profiles/now.md) — Now: R2 batch 2 applied (4 new entries + 4 edits; asset-registry partition removed) — 9 partitions — hub build at M1, memory system live
