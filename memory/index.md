...
- [now](/memory/profiles/now.md) — Now: CONTENT PARITY COMPLETE (monolith batches 1–4 + knowledge-review batch 5 + R3 seed all migrated) — 9 partitions — hub build at M1, memory system live
