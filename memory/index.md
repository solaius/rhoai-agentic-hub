...
## Recent log
- 2026-07-06 — **Update** — R4 wave 3: customer-feedback suite ported (tracker data model: restricted + external c-tracker; rhai-tracker doctor section live; customer names scrubbed from skill texts). Active R4 waves complete.
