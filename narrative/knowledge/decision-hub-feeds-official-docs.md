...
---
**Context:** Peter built component-level knowledge hubs (e.g., RHCL hub for
...
make inference work for agents, etc.) and connects that to components, Jiras,
...
- Component knowledge already organized and verified
